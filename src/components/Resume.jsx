        ...
        {['Experience', 'Education', 'Certificates', 'Skills', 'About me'].map((button) => (
          <button
            ...
            className={`px-3 py-1 sm:px-4 sm:py-2 rounded-lg ${
              activeSection === button ? 'bg-green-500' : 'bg-gray-800'
      ...
      {activeSection === 'Experience' && (
        <div>
          ...
          <ul className='list-disc ml-5 text-sm sm:text-base'>
            <li className='mt-4'>
              <strong>Software Engineering Intern - FPT Software</strong>
              <br />
              <ul className='list-inside list-disc'>
                <li>Completed a 4-month internship at FPT Software as a Software Engineering Intern.</li>
                <li>
                  Worked on backend development using NestJS, gaining hands-on experience in building APIs and
                  server-side logic.
                </li>
                <li>
                  Developed and optimized backend services, focusing on authentication, database interactions, and
                  performance improvements.
                </li>
                <li>
                  Had exposure to Next.js for frontend development, learning how to integrate frontend with backend
                  services efficiently.
                </li>
                <li>
                  Collaborated with backend and frontend teams to ensure smooth API integration and improve system
                  architecture.
                </li>
                <li>Focused on improving backend skills to gain deeper experience in server-side development.</li>
                <li>
                  Learned about Agile methodologies, participated in daily stand-up meetings, and contributed to sprint
        ...
        <div>
          ...
          <div className='grid grid-cols-1 sm:grid-cols-2 gap-4'>
            {[
              ...
              <div
                key={cert.name}
                className='bg-gray-800 p-3 sm:p-4 rounded-lg shadow-md hover:bg-gray-700 transition duration-300'
              >
                <h3 className='text-base sm:text-lg font-semibold text-white mb-1'>{cert.name}</h3>
                <a
                  href={cert.link}
                  className='text-green-400 hover:underline text-xs sm:text-sm'
                  target='_blank'
      ...
      {activeSection === 'About me' && (
        <div>
          ...
          <p className='text-sm sm:text-base'>
            I am a fourth-year student specializing in software engineering. I love building web applications and
