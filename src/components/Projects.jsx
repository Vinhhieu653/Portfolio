...
const projects = [
    { id: 1, name: 'MILKSTORE PROJECT', description: 'React JS, MongoDB, Express, Node JS', link: 'https://github.com/Vinhhieu653/milk-store.git', image: milk },
    { id: 2, name: 'E-COMMERCE PROJECT', description: 'React JS, MongoDB, Express, Node JS', link: 'https://github.com/Vinhhieu653/E-Commerce.git', image: ecommerce },
];
